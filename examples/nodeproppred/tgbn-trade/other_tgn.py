...
def train():
    ...
    for batch in train_loader:
        ...
        if query_t > label_t:
            ...
            #           print(labels.size(), label_srcs.size())
            #            print("skipped", skipped, "updated", query_t, label_t)
            skipped = 0
            ...
            print(n_id)
            print(n_id_neighbors)
            print(mem_edge_index)
            exit(0)
